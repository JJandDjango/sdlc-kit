...
| playbook alignment | Anthropic's AI-native SDLC playbook crosswalked to the 56 conditions; six gaps close in two contracts: `playbook-guardrails` (session hooks, G4.12 scope check, REVIEW.md; 0.13.0) and `playbook-loop` (G9.5 re-scan, flow metrics, PO venue, eval refs; 0.14.0) | planned | [decisions/0027](decisions/0027-playbook-crosswalk-and-closures.md) |
