...
```bash
uv run --no-project --with "sdlc-taskcontract @ git+https://github.com/JJandDjango/sdlc-kit.git@v0.12.0" python -m taskcontract validate specs/<task-id>/contract.yaml --profile ready
```
